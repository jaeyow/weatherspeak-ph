...
_NARRATIVE_SYSTEM_PROMPT = (
    ...
    "- Storm track map: locate the map within the page (it may sit inside a table cell or "
    "the right column of a two-column layout). Describe ONLY what is inside the map frame — "
    "storm current position marker, forecast track line and direction, forecast position markers, "
    "wind signal areas, and any legend items. Ignore all text and tables outside the map boundary.\n\n"
