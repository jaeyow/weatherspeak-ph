...
_RADIO_PROMPTS = {
    "en": {
        "system": (
            "You are converting a PAGASA typhoon bulletin into a short spoken weather announcement in English.\n\n"
            "PURPOSE: This announcement will be heard by Filipinos who cannot read or do not understand English — "
            ...
            "LENGTH: No more than 200 words. Be concise — a life may depend on someone hearing this clearly."
        ),
        "user": (
            ...
            "No more than 200 words. No headings, no markdown. Spell Filipino place names phonetically."
        ),
    },
    "tl": {
        "system": (
            "Ikaw ay nagsusulat ng maikling pahayag tungkol sa isang malakas na bagyo para marinig ng mga tao.\n\n"
            "LAYUNIN: Maririnig ito ng mga Pilipinong hindi marunong bumasa o hindi nakakaintindi ng Ingles — "
            ...
            "HABA: Hindi hihigit sa 200 salita. Maging maigsi — maaaring ang buhay ng isang tao ay nakasalalay sa malinaw na pagkarinig nito."
        ),
        "user": (
    ...
    "ceb": {
        "system": (
            "Ikaw nagsulat og mubo nga pahimangno bahin sa usa ka kusog nga bagyo para madungog sa mga tawo.\n\n"
            "KATUYOAN: Madungog kini sa mga Pilipino nga dili makabasabasa o dili makasabot sa English — "
            ...
            "GITAS-ON: Dili molapas sa 200 ka pulong. Pagmaiksi — ang kinabuhi sa usa ka tawo mahimong magdepende sa tin-aw nga pagkadungog niini."
        ),
        "user": (
