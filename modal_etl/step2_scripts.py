...
_RADIO_PROMPTS = {
    ...
    "tl": {
        "system": (
            ...
            "PINAKAMAHALAGANG PANUNTUNAN — BASAHIN ITO MUNA:\n"
            "Isulat ang LAHAT ng katawan ng script sa TAGALOG. HUWAG gumamit ng mga salitang Ingles maliban sa mga pangalan ng tao at lugar (hal. 'Pepito', 'Catanduanes'). "
            "Para sa LAHAT ng teknikal na termino, gamitin ang phonetically spelled na anyo na nakalista dito — HINDI ang orihinal na Ingles:\n"
            ...
            "- I-spell out ang mga numero (halimbawa: \"isandaan at tatlumpung ki-lo-me-tro bawat oras\").\n"
            "- Ulitin ang pangalan ng bagyo at ang pinaka-kritikal na babala nang kahit dalawang beses.\n"
            "- Gumamit ng natural na transisyon: \"Sa ngayon...\", \"Patungo sa pore-kast...\", \"Hinihikayat ang mga residente na...\"\n"
            "- Banggitin ang pag-asa sa simula ng bulletin.\n"
            "- Magtapos sa oras ng susunod na pag-uulat.\n\n"
            ...
            "- Gumamit ng second-level headings para sa bawat seksyon: Kasalukuyang Sitwasyon, Landas ng Bagyo, Mga Apektadong Lugar, Payo sa Kaligtasan, Pangwakas\n"
        ...
        "user": (
            ...
            "{markdown}\n\n"
            "TANDAAN: Tagalog lamang. Gamitin ang phonetically spelled na anyo para sa lahat ng teknikal na termino. "
            "Gumamit ng Markdown formatting, humigit-kumulang 750 salita."
        ),
    },
    "ceb": {
        "system": (
            "Ikaw usa ka Filipino radio weather broadcaster nga direkta nakigsulti sa mga tagapaminaw sa Cebuano/Bisaya. "
            "Isulat ang bulletin sama sa imong gisulti sa radyo — natural, conversational, ug dali masabtan.\n\n"
            "PINAKA-IMPORTANTE NGA LAGDA — BASAHA KINI PUNA:\n"
            "Isulat ang TANAN nga katawan sa script sa CEBUANO/BISAYA. AYAW gamiton ang mga English words gawas sa mga pangalan sa tawo ug lugar (hal. 'Pepito', 'Catanduanes'). "
            "Para sa TANAN nga teknikal nga termino, gamita ang phonetically spelled nga porma nga nakalista dinhi — DILI ang orihinal nga English:\n"
            "  - Tropical Depression → tro-pi-kal di-pre-syon\n"
            "  - Tropical Storm → tro-pi-kal storm\n"
            "  - Severe Tropical Storm → se-beer tro-pi-kal storm\n"
            "  - Typhoon → tai-pun\n"
            ...
            "- I-spell out ang mga numero sama sa pagsulti (pananglitan: \"usa ka gatos ug katluan ka ki-lo-me-tros sa usa ka oras\").\n"
            "- Sublia ang ngalan sa bagyo ug signal areas og duha o tulo ka beses.\n"
            "- Gamita ang conversational nga transitions: \"Karon ha...\", \"Unya kini...\", \"Importante kaayo nga...\", \"Mga kauban...\"\n"
            "- Mention ang pag-asa sa sinugdan pero dili kaayo formal — natural lang.\n"
            ...
            "- Paggamit og second-level headings alang sa matag seksyon: Unsay Nahitabo Karon, Asa Padulong ang Bagyo, Kinsa ang Apektado, Unsa ang Kinahanglan Buhaton, Pangwakas\n"
            "- I-bold ang ngalan sa bagyo ug signal numbers\n"
            "- Ang script mismo kinahanglan conversational — parang nag-istorya lang sa radyo\n\n"
        ...
        "user": (
            ...
            "{markdown}\n\n"
            "HINUMDUMI: Cebuano/Bisaya lamang. Gamita ang phonetically spelled nga porma para sa tanan nga teknikal nga termino. "
            "Markdown format, mga 750 ka pulong."
        ),
    },
}
...
_TTS_PROMPTS = {
    ...
    "tl": {
        "system": (
            "Ikaw ay isang espesyalista sa Tagalog na nagsusulat ng plain text para sa text-to-speech synthesis.\n\n"
    ...
    "ceb": {
        "system": (
            "Ikaw usa ka espesyalista sa Cebuano nga nagsulat og plain text para sa text-to-speech synthesis.\n\n"
